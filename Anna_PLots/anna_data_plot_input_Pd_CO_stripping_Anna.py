...
if not load_new_data:
    ...
    folder_path = r'\\dtu-storage\annawi\Desktop\Projects\Propene oxidation\Experiments\Pd-electrodes\EC and product analysis'
    OrderedDict([ ])
    ...
    filenames = OrderedDict([('20170831_Pd_039', ['AW_Pd_039_02_CVA_C01.mpt',
                                                   'AW_Pd_039_03_CA_C01.mpt',
                                                   'AW_Pd_039_05_CA_C01.mpt'
                                                   ]),
                              ('20170901_Pd_040', ['AW_Pd_040_01_CA_C01.mpt',
                                                   'AW_Pd_040_02_CVA_C01.mpt',
                                                   'AW_Pd_040_03_CA_C01.mpt',
                              ...
                              ('20170916_Pd_046', ['AW_Pd_046_02_CVA_C01.mpt',
                                                   'AW_Pd_046_05_CA_C01.mpt'
                                                   ]),
                              ('20171003_Pd_047', ['20171003_AW_Pd047_COstripping_test_02_CVA_C01.mpt',
                                                   '20171003_AW_Pd047_COstripping_test_03_CVA_C01.mpt',
                                                   '20171003_AW_Pd047_COstripping_test_04_CVA_C01.mpt'
                                                   ]),
                              ('20171003_Pd_048', ['20171003_AW_Pd048_COstripping_test_02_CVA_C01.mpt',
                                                   '20171003_AW_Pd048_COstripping_test_04_CVA_C01.mpt',
                                                   '20171003_AW_Pd048_COstripping_test_05_CVA_C01.mpt'
                                                   ]),
                              ('20171005_Pd_049', [
                                                   # '20171005_AW_Pd049_02_CA_C01.mpt',
                                                   # '20171005_AW_Pd049_2ndtry_04_CVA_C01.mpt',
                              ...
                              ('20171006_Pd_050', [
                                                   ...
                                                   # '20171006_AW_Pd050_onlyAr_restart_02_CA_C01.mpt',
                              ...
                              ('20171010_Pd_051', [
                                                   ...
                                                   # '20171010_AW_Pd051_06_CA_C01.mpt',
                              ...
                              ('20171011_Pd_052', [
                                                   ...
                                                   # '20171011_AW_Pd_052_2ndgo_08_CVA_C01.mpt'
                                                   ])
    ...
    filespec_settings = {
                        ...
                        "20171011_AW_Pd_052_2ndgo_05_CVA_C01.mpt": {"electrode area geom": 2, "cycles to extract": [2, 3],
                                                    "label": "Pd_052 CO strip"},
                        "20171010_AW_Pd051_05_CVA_C01.mpt": {"electrode area geom": 2, "cycles to extract": [3, 4],
                                             "label": "Pd_051 CO strip"},
                        "20171006_AW_Pd050_onlyAr_05_CVA_C01.mpt": {"electrode area geom": 2, "cycles to extract": [2, 3],
                                                    "label": "Pd_050 CO strip"},
                        "20171005_AW_Pd049_2ndtry_05_CVA_C01.mpt": {"electrode area geom": 2, "cycles to extract": [2, 3],
                                                    "label": "Pd_049 CO strip"}
...
if not input_plot_settings:
    ...
    plot_settings = {'safeplot': True,
                     'plotname': "20180910_CV_Pd049_COstrip_2",
                     ...
                     'l_pad': [],
                     'r_pad': [],
                     'colors': ['r', 'k', '0.25',[0.03137255, 0.20853518, 0.4497501, 1.], 'b', 'grey','k', 'r', '#4a235a', 'c', '#538612', 'c', 'm', '0.50',"#538612", '0.75'],
...
def main():
    ...
    # esca_data = dpf.calc_esca(datalist[0:17], type='CO_strip', scanrate=20, charge_p_area=1)
    # print(esca_data)
