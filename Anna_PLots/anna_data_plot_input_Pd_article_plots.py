...
if not input_plot_settings:
    ...
    plot_settings = {'safeplot': True,
                     ...
                     "axis label size": 10,
                     "tick label size": 10,
                     "plot_average_cond": {"EvsRHE/V":[0.95, 1.0, 1.1, 1.2], "not_average":['20180222_Pd_107_03_CA_C01.mpt']} #, "not_average": ['20180222_Pd_107_03_CA_C01.mpt']} #{"EvsRHE/V":[0.85, 0.9, 0.95]}#{"EvsRHE/V":[0.7, 0.8, 0.85, 0.9 ,0.95, 1.0, 1.1, 1.2]}
                     }
